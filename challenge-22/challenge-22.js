(function(){
  ...
  */
  ...
  var person1 = new Person('Mary', 'Smith');
  var person2 = new Person('John', 'Simpson');
  ...
  */
  function sum() {
    ...
    var sumResult = Array.prototype.reduce.call(arguments, function(acumulate, actulItem) {
      return acumulate + actulItem;
    });
    return sumResult;
  }
  ...
  */
  ...
  console.log(sum(1, 1, 2, 3, 5, 8, 13, 21));
  ...
  */
  ...
  function justNumbers(strNumbers) {
    var regexNumbers = /\D+/g;
    return strNumbers.replace(regexNumbers, ',').split(',')
      .map(function(item) {
