(function(){
    ...
    */
    ...
    console.log(sum ?
        showOperationMessage(operationSignal, number1, number2)+' '+sum(number1, number2) :
    ...
    */
    ...
    console.log( subtraction ?
        showOperationMessage(operationSignal2, number1, number2)+' '+subtraction(number1, number2) :
        showErrorMessage(operationSignal2)
    );

    var operationSignal3 = '*';
    var multiplication = calculator(operationSignal3);
    console.log( multiplication ?
        showOperationMessage(operationSignal3, number1, number2)+' '+multiplication(number1, number2) :
        showErrorMessage(operationSignal3)
    );

    var operationSignal4 = '/';
    var division = calculator(operationSignal4);
    console.log( division ?
        showOperationMessage(operationSignal4, number1, number2)+' '+division(number1, number2) :
        showErrorMessage(operationSignal4)
    );

    var operationSignal5 = '%';
    var mod = calculator(operationSignal5);
    console.log( mod ?
        showOperationMessage(operationSignal5, number1, number2)+' '+mod(number1, number2) :
        showErrorMessage(operationSignal5)
    );
    /*
    Repita o PASSO 2 novamente, mas passando um operador inválido, para ver se
    a mensagem de erro será mostrada no console.
    */
    var operationSignal6 = 'y';
    var test = calculator(operationSignal6);
    console.log( test ?
        showOperationMessage(operationSignal6, number1, number2)+' '+test(number1, number2) :
        showErrorMessage(operationSignal6)
    );
