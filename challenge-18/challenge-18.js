(function(){
    ...
    */
    ...
    console.log(phrase.match(/ju\w+/g))
    ...
    */
    ...
    var tagsHtml = '<div><section><blockquote>Texto <img /></blockquote></section></div>';
    console.log(tagsHtml.match(/<\w+>/g));
    ...
    */
    ...
    var moreTags = '<div><ul><li></li><li></li><li><span></span></li></ul></div>'
    console.log(moreTags.match(/<\w+><\/\w+>/g));
    ...
    */
    ...
    tags.replace(/<(\w+)>([^>]+)<\/\w+>/g,function(regex, cap1, cap2){
        console.log('O texto dentro da tag "'+cap1+'" é "'+cap2+'"')
    });
})();