...
*/
console.log( '\nOperation 2:' );
var operation2 = justMod2Or3.reduceRight(function(total, index){
    total = total + 1;
    return total * index;
}, 0);
...
console.log(
    name.reduce(function(acumulado, atual){
        return acumulado = acumulado + 'p' + atual;
    }, '')    
);
...
var index = numberObjects[1];

console.log(numberObjects.indexOf(index) > -1 ? 
    'Existe um objeto { number: 2 } em numberObjects!':
    'Não existe um objeto { number: 2 } em numberObjects :('
);
...
console.log(numberObjects.lastIndexOf(index, 2) > -1 ? 
    'Existe um objeto { number: 2 } em numberObjects!':
    'Não existe um objeto { number: 2 } em numberObjects :('
);
