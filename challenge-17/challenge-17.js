(function(){
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Emanuel Cerqueira'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/, 'santoamarense'));
    ...
    */
    console.log( '\nReplace de datas:' );
    function replaceDate(dateText, day, month, year) {
        return dateText.replace(dateText, day+'/'+getMonthNumber(month)+'/'+year);
    }
