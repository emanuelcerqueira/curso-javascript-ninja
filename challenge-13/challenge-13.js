...
var isMaisSeteLetras = brasil.every(function(item){
    return item.length > 7;
});
console.log(isMaisSeteLetras ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras!');
/*
...
var isCearaInculido = brasil.some(function(item){
   return item === 'Ceará';

});
console.log(isCearaInculido ? 'Ceará está incluído!' : 'Ceará não foi incluído :(');
/*
