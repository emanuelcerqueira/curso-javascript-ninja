...
console.log('O nome da funcão que faz a soma é '+nomeFuncao+'.');
...
function calculator(operador) {
	...
	return function (num1, num2) {
		...
		return 	'Resultado da operação: '+num1+' '+operador+' '+num2+' = '+resultadoOperacao+'.';
	};
}
